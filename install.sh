#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cores.conf'
CONFIGFOLDER='/root/.cores/'
COIN_DAEMON='/usr/local/bin/coresd'
COIN_CLI='/usr/local/bin/cores-cli'
COIN_REPO='https://github.com/Coresmail/CoresCore/releases/download/2.2/cores.tar.gz'
COIN_NAME='cores'
COIN_PORT=36550
RPC_PORT=16020
